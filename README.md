...
# Read the image
img = cv2.imread('My photo.jpeg',cv2.IMREAD_GRAYSCALE)
...
```
# Output
<img width="742" height="425" alt="download" src="https://github.com/user-attachments/assets/ec1e6f47-8520-448e-9dcc-0153f0115988" />
